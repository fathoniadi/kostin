	        ...
	        <div class="col-md-12">
	            <div class="form-group">
	                ...
	                <select name="harga" class="form-control filter">
	                    ...
	                    <option @if(isset($params['harga'])) @if($params['harga'] == 1) selected @endif @endif value="1">0-500.000</option>
	                    <option @if(isset($params['harga'])) @if($params['harga'] == 2) selected @endif @endif value="2">500.001-1.000.000</option>
	                    <option @if(isset($params['harga'])) @if($params['harga'] == 3) selected @endif @endif value="3"><1.000.001</option>
	                </select>
	            </div>
	        </div>
	        <div class="col-md-6">
